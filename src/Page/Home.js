          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  Empower your developers and save them hours with automated and
                  AI developed stunning API documentation.
                </p>
                <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
                  <li>
                    {/* <span
                      ...
                      onClick={
                        () => handleJoinWaitlist("hero")
                      }
                      className="inline-flex items-center justify-center rounded-md  px-7 py-[14px] text-center text-base font-medium text-dark shadow-1 font-bold transition duration-300 ease-in-out hover:bg-gray-2 hover:text-white"
                    >
                      🚀 Join the waitlist
                    </span> */}
                    <GoogleLogin
            ...
            <div className="w-full px-4">
              ...
              >
                <div className="mt-16">
                  <img
                    src={require("../assets/images/Galileo design.png")}
                    alt="hero"
