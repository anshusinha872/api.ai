            ...
            <div className="w-full px-4">
              <div className="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                ...
                Swagger can help you design and document your APIs at scale. */}
                  Generate stunning API documentation in seconds, not days, with
                  our AI-powered tool. No hand-coding needed! Empower users,
                  teams, and enterprises to flawlessly document and manage APIs
                  at scale. Unlock the power of AI and see how easy API
